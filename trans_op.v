(*type and translate the store first to be able to type locations *)
Inductive trans_erasure: source.context -> (source.term * source.store) -> source.term -> (Syntax.term obj) -> Prop :=
|  t_bind: forall G S St E1 Et1 E2 Et2,
    trans G (bind E1 E2) (comp_m B) Et ->
    trans_store G S St ->
    trans_erasure G (bind E1 E2) (comp_m B) (app Et | )
                                   trans G (E1, S) (comp_m A) (Et1, St) ->
                                   trans (A::G) (E2, S) (comp_m B) Et2 ->
