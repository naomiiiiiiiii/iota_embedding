...
\]
I am showing
%start here can move these around if necessary
...
\begin{itemize}
    ...
    Apply 68 to get (amongst goals solved before)
     ...
     which is to say
      ...
      (\bigcirc \tau_1) @ W_1\]
        I have by induction on $\Gamma \vdash e_1 : \bigcirc \tau_1$ that $\cdot \vdash \overline{e_1} : \forall(w_1: pw)\Pi(l_1: \N)(\Gamma @ \langle w_1, l_1 \rangle \imp (\bigcirc \tau_1) @ W_1)$. The desired result follows by weakening typing rule for application, removing the forall first, and weakening.
